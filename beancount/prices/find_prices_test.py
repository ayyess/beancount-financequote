...
class TestImportSource(unittest.TestCase):
    ...
    def test_import_source_valid(self):
        for name in 'google', 'yahoo', 'financequote':
...
class TestParseSource(unittest.TestCase):
    ...
    def test_source_valid(self):
        psource = find_prices.parse_single_source('financequote/NASDAQ:AAPL')
        self.assertEqual(PS(financequote, 'NASDAQ:AAPL', False), psource)
